...
from mlx_fish_speech.content_sequence import (
    AudioPart,
    BasePart,
    ContentSequence,
    EncodedMessage,
...
from mlx_fish_speech.tokenizer import IM_END_TOKEN, IM_START_TOKEN, MODALITY_TOKENS
...
if __name__ == "__main__":
    ...
    _tok = Path(__file__).resolve().parent.parent / "weights" / "openaudio-s1-mini"
    tokenizer = PreTrainedTokenizerFast.from_pretrained(str(_tok))
